...
process Extract_HLA {
	...
	output:
	file "*.extracted" into extracted

	publishDir "extracted/", pattern: "*.extracted", mode: "copy"
	...
	# all merged
	samtools merge hla.bam all.1.bam all.2.bam all.3.bam hla.mapped_only.bam

	touch ${my_file}.extracted
	"""
}
